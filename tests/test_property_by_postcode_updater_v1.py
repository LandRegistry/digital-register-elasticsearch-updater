...
class TestPropertyByPostcodeUpdaterV1:
    ...
    def test_initialise_loads_state(self):
        ...
        with mock.patch(
            ...
            PropertyByPostcodeUpdaterV1().initialise(index_name, doc_type)
    ...
    def test_get_next_source_data_page_calls_page_reader_with_right_args(self, mock_get_page):
        ...
        with mock.patch(
            ...
            PropertyByPostcodeUpdaterV1().get_next_source_data_page(page_size)
    ...
    def test_get_next_source_data_page_returns_result_from_page_reader(self):
        ...
        with mock.patch('service.updaters.property_by_postcode_updater_v1.get_next_data_page',
            ...
            with mock.patch('service.es_status_loader.load_index_update_status',
                ...
                result = PropertyByPostcodeUpdaterV1().get_next_source_data_page(123)
    ...
    def test_get_mapping_returns_correct_mapping(self):
        assert PropertyByPostcodeUpdaterV1().get_mapping() == {
            'properties': {
